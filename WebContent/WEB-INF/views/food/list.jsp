...
<html>
	...
	<body>
		<div class="condition">
			菜品名称：<input id="search-name" type="text">
			<label>所属分类:</label>
	...
	<form id="add-form" method="post">
        <table>
            <tr>
                ...
                <td valign="middle">
                	<img id="preview-photo" style="float:left;" src="/CateringSystem/resources/img/cl01.jpg" width="100px">
            ...
            <tr>
                ...
                <td><input type="text" id="add-photo" name="imageUrl" value="/CateringSystem/resources/img/cl01.jpg" readonly="readonly" class="wu-text " /></td>
            </tr>
            <tr>
	...
	<form id="edit-form" method="post">
        ...
        <table>
            <tr>
                <td width="60" align="right">图片预览:</td>
                <td valign="middle">
                	<img id="edit-preview-photo" style="float:left;" src="/CateringSystem/resources/img/cl01.jpg" width="100px">
                	<a style="float:left;margin-top:40px;" href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-upload" onclick="uploadPhoto()" plain="true">上传图片</a>
                </td>
            </tr>
            <tr>
                <td width="60" align="right">图片:</td>
                <td><input type="text" id="edit-photo" name="imageUrl" value="/CateringSystem/resources/img/cl01.jpg" readonly="readonly" class="wu-text " /></td>
            </tr>
            <tr>
                <td width="60" align="right">名称:</td>

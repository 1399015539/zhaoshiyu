...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <link rel="stylesheet" media="screen" href="../resources/css/login/css/style.css">
  <link rel="stylesheet" type="text/css" href="../resources/css/login/css/reset.css">
<body>
...
<div id="particles-js">
		<div class="login" style="display: block;">
			...
			<div class="login-center clearfix">
				<div class="login-center-img"><img src="../resources/css/login/images/name.png"></div>
			...
			<div class="login-center clearfix">
				<div class="login-center-img"><img src="../resources/css/login/images/password.png"></div>
				<div class="login-center-input">
			...
			<div class="login-center clearfix">
				<div class="login-center-img"><img src="../resources/css/login/images/cpacha.png"></div>
				<div class="login-center-input">
...
<!-- scripts -->
<script src="../resources/css/login/js/particles.min.js"></script>
<script src="../resources/css/login/js/app.js"></script>
<script src="../resources/css/login/js/jquery-1.8.0.min.js"></script>

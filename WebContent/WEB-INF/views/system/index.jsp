...
<link rel="stylesheet" type="text/css" href="../resources/easyui/css/wu.css" />
...
<script type="text/javascript" src="../resources/easyui/easyui/1.3.4/locale/easyui-lang-zh_CN.js"></script>
<script>
    var pc; 
    //不要放在$(function(){});中
...
<body class="easyui-layout">
	...
	<div class="wu-header" data-options="region:'north',border:false,split:true">
        ...
        <div class="wu-header-right">
            ...
            <p><a href="../home/index/index">网站首页</a>|<a href="#">支持论坛</a>|<a href="edit_password">修改密码</a>|<a href="logout">安全退出</a></p>
        </div>
    </div>
    <!-- end of header -->
    <!-- begin of sidebar -->
